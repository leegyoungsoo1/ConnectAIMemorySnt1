...
def main():
    ...
    parser.add_argument('--output', help='결과 저장 JSON (기본: scan_results.json)',
                        default=os.path.join(os.path.dirname(__file__), 'scan_results.json'))
    ...
    print("→ 2단계: service_vuln_check.py 실행하여 서비스별 취약점 점검")
